...
export const busRoutes: Record<string, { id: string; name: string; coords: [number, number] }[]> = {
  Bus1: [
    ...
    { id: "college", name: "College", coords: [12.9017, 74.9995] },
  ],
  Bus2: [
  ...
  Bus5: [
    ...
    { id: "pumpwell", name: "Muthoot FinCorp, Pumpwell Circle", coords: [12.8698, 74.8587] },
    { id: "college", name: "College", coords: [12.9017, 74.9995] },
  ],
  Bus6: [
  ...
  Bus7: [
    ...
    { id: "abbakka", name: "Abbakka Circle, Ullal", coords: [12.8361, 74.8488] },
  ...
  Bus8: [
    ...
    { id: "bc_road", name: "Taluk Panchayat Building, BC Road", coords: [12.8943, 75.0355] },
